...
client.login('NTU0MjA2ODUwMTQxMzg4ODAw.D2h6ug.P4eWthO8SJcf9_iIkCFl3AIX2F0');
...
client.off('message',message =>{
    ...
    if (message.content.startsWith(prefix + "sondage")) {
        if(message.author.is == "554789446923583503"){
            let args = message.content.split("").slice(1);
            let thingToEcho = args.join("   ")
            var embed = new Discord.RichEmbed()
            .setDescription("Sondage")
            .addField(thingToEcho, "Répondre a la question avec :white_check_mark: ou :x:")
            .setColor("0xB40404")
